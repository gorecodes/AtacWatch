    ...
    <div>
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-neutral-800 bg-neutral-900 py-3 pl-10 pr-4 text-base outline-none placeholder:text-neutral-500 focus:border-neutral-600"
        />
      </div>
      {!hasQuery && (
                ...
                {routes.map((r) => (
                  <li key={r.route_id}>
                    <button
                      ...
                      className="flex w-full items-center gap-3 rounded-xl border border-neutral-800 bg-neutral-900 px-3 py-2.5 text-left active:bg-neutral-800"
                    >
