    ...
    <div className="mx-auto max-w-lg">
      <header className="flex items-center gap-3 px-4 pt-5 pb-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={load} className="text-xs text-brand-600">Aggiorna</button>
        </div>
      </header>
            ...
            <li key={`${a.route_id}-${a.direction_id}-${a.eta_ts}-${i}`}>
              <Link href={href} className="flex items-center gap-3 py-3 active:opacity-70">
                ...
                <div className="flex items-center gap-1 text-right">
                  <span className={`text-base font-semibold tabular-nums ${a.is_realtime ? "text-emerald-600" : "text-neutral-700"}`}>
